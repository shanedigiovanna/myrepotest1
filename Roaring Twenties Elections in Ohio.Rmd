...
and I have done some preliminary processing to make the next steps easier. 
...
```{r data}
url_20s = "https://raw.githubusercontent.com/shanedigiovanna/myrepotest1/main/Ohio%20Coolidge%20Hoover%20elections.csv"
twenties_data <- read_csv(url(url_20s))

url_counties = "https://github.com/shanedigiovanna/myrepotest1/blob/main/UScounties.shp?raw=true"
county_shp <- st_read(url(url_counties))
```
...
Next, we need to merge the election data, `twenties_data`, with thye county shapefile, `oh_county_shp`:
...
legend.position = c("right", "bottom")) +
    tm_layout(main.title = "Ohio 1924 Presidential Party Margin by County", main.title.position = "center", legend.title.size = 0.9) +
...
legend.position = c("right", "bottom")) +
    tm_layout(main.title = "Ohio 1928 Presidential Party Margin by County", main.title.position = "center", legend.title.size = 0.9) +
...
legend.position = c("right", "bottom")) +
    tm_layout(main.title = "Ohio Robert La Follette Vote Share in\n1924 Presidential Election", main.title.position = "center", legend.title.size = 0.9) +
